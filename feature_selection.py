...
from ISCSO import ImprovedSandCatSwarmOptimizer
...
def select_features(df):
    ...
    print("[INFO] Feature Selection Using Improved Sand Cat Swarm Optimizer")
    solution = ImprovedSandCatSwarmOptimizer(
        num_agents=1,
        max_iter=25,
        train_data=x_,
        train_label=y_,
...
if __name__ == "__main__":
    ...
    select_features(preprocess_data(load_data()))
